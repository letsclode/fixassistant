...
class ExpenseRecurrent extends StatefulWidget {
  @override
  _ExpenseRecurrentState createState() => _ExpenseRecurrentState();
}

class _ExpenseRecurrentState extends State<ExpenseRecurrent> {
  ...
  Stream updateAddStat() async* {
    setState(() {
      _addRecStat = addRecStat;
    });
    yield _addRecStat;
  }
        ...
        child: Stack(
          children: <Widget>[
                ...
                children: <Widget>[
                      ...
                      child: ListView(
                        children: <Widget>[
                          Column(
                            ...
                            children: <Widget>[
                              Text(
                                totalrecExpense.toStringAsFixed(2) +
                              ...
                              Text(
                                locale == "en" ? tempPeriod1[selectedBudget['period_type']]: tempPeriod2[selectedBudget['period_type']],
                  ...
                  StreamBuilder<Object>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            return snapshot.data ? AddEI(2) : Container();
                          }
                        )
                ],
              ),
            ...
            showBin
                ? BackdropFilter(
                    ...
                    child: Container(
                      ...
                      width: scrW,
                      height: scrH,
                      color: ThemeProvider.themeOf(context).id == 'dark' ?  Colors.grey.shade800.withOpacity(0.5) : Colors.grey.shade200.withOpacity(0.5),
            ...
            loadManage == true
                ...
                : Container(),
            // StreamBuilder(
            //     stream: updateAddStat(),
            //     builder: (context, snapshot) {
            //       return snapshot.data != null
            //           ? snapshot.data
            //               ? AddingRecCat(_category,_index)
            //               : Container()
            //           : Container();
            //     })
          ],
